...
DynamicForest::DynamicForest(DynamicForest &&other) noexcept
    : num_vertices_{other.num_vertices_}, vertices_{std::move(other.vertices_)}, edge_elements_{std::move(other.edge_elements_)}, free_edge_elements_{std::move(other.free_edge_elements_)}, edges_{std::move(other.edges_)} {}
